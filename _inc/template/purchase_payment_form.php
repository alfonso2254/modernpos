...
<div class="bootbox-body">
	<div class="table-selection">
		...
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-7 pmethod-options-content bootboox-container checkout-payment-option">
			<div class="tab-wrapper tab-cheque bootboox-container pmethods-payment-form">
				<h4 ng-show="pmethodId" class="text-center"><?php echo $language->get('text_pmethod'); ?> <b>{{ pmethodName }}</b></h4>
				...
				<div class="mt-5">
					<textarea name="note" class="form-control note" placeholder="<?php echo $language->get('placeholder_note_here');?>">{{ invoiceNote }}</textarea>
				</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 cart-details hidden-xs bootboox-container">
			<div class="table-responsive mt-30">
				<table class="table table-bordered table-striped">
					<tbody>
						<tr>
							<td><?php echo $language->get('button_full_payment'); ?></td>
				...
				<table class="table table-bordered">
					...
					<tfoot>
						...
						<tr ng-repeat="payments in order.payments" class="{{ payments.type=='return' ? 'danger' : 'success' }}">
							...
							<td ng-show="payments.type=='purchase'" class="text-right w-40">{{ payments.amount | number:2 }}</td>
